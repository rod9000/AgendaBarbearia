            ...
            <div class="card-pastel">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="cnpj" value="{{ old('cnpj', $company->cnpj) }}" class="input-pastel" placeholder="00.000.000/0000-00">
                    ...
                    <div>
                        ...
                        <input type="text" name="whatsapp" value="{{ old('whatsapp', $company->whatsapp) }}" class="input-pastel" placeholder="(44) 99999-9999">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="cep" value="{{ old('cep', $company->cep) }}" class="input-pastel" placeholder="00000-000">
